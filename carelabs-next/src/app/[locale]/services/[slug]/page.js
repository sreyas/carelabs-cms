...
<section>
  <div className="w-full min-h-[300px] flex items-center justify-center px-4 pt-40 sm:pt-10 py-10 bg-[#f9fbfe]">
        ...
        return (
          <div
            ...
            className="
              ...
              hover:scale-[1.03] hover:-translate-y-1 origin-bottom
            "
          >
